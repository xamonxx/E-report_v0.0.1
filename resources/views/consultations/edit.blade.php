    ...
    <div class="bg-surface-container-lowest rounded-2xl shadow-sm p-5 sm:p-8 border border-surface-container-low">
        ...
        <form method="POST" action="{{ route('consultations.update', $consultation) }}" class="space-y-6 sm:space-y-8">
            ...
            <div class="space-y-5 sm:space-y-6"
                ...
                <div class="space-y-2">
                    <label for="product_details" class="block text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">CATATAN / KETERANGAN (optional)</label>
                    <textarea id="product_details" name="product_details" rows="3" maxlength="1500"
                              ...
                              placeholder="Tulis rincian kebutuhan produk klien...">{{ old('product_details', $consultation->product_details) }}</textarea>
                </div>
