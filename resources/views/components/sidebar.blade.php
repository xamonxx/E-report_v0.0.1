...
<aside role="navigation" aria-label="Sidebar navigasi" class="glass-sidebar h-screen flex flex-col py-6 w-full shrink-0 bg-surface-container-low lg:bg-surface-container-low/90 backdrop-blur-md border-r border-surface-container-high lg:border-r-0">
    ...
    <nav class="flex-1 px-4 space-y-1 overflow-y-auto custom-scrollbar">
        <a href="{{ route('dashboard') }}" @click="if(window.innerWidth < 1024) sidebarOpen = false" aria-label="Beranda" title="Beranda"
           class="flex items-center py-3 rounded-lg transition-colors font-headline text-sm tracking-tight
                  {{ $currentRoute === 'dashboard' ? 'text-primary font-semibold border-r-2 border-primary bg-surface-container-high/80' : 'text-on-surface-variant hover:bg-surface-container-high/70 hover:text-on-surface' }}
        ...
        <a href="{{ route('accounts.index') }}" @click="if(window.innerWidth < 1024) sidebarOpen = false" aria-label="Akun" title="Akun"
           class="flex items-center py-3 rounded-lg transition-colors font-headline text-sm tracking-tight
                  {{ str_starts_with($currentRoute, 'accounts') ? 'text-primary font-semibold border-r-2 border-primary bg-surface-container-high/80' : 'text-on-surface-variant hover:bg-surface-container-high/70 hover:text-on-surface' }}
                  {{ $isSidebarOpen ? 'gap-3 px-4 justify-start' : 'justify-center px-0' }}"
           :class="(isMobile || sidebarOpen) ? '!gap-3 !px-4 !justify-start' : '!justify-center !px-0'">
        ...
        <a href="{{ route('consultations.index') }}" @click="if(window.innerWidth < 1024) sidebarOpen = false" aria-label="Daftar Lead" title="Daftar Lead"
           class="flex items-center py-3 rounded-lg transition-colors font-headline text-sm tracking-tight
                  {{ str_starts_with($currentRoute, 'consultations') ? 'text-primary font-semibold border-r-2 border-primary bg-surface-container-high/80' : 'text-on-surface-variant hover:bg-surface-container-high/70 hover:text-on-surface' }}
                  {{ $isSidebarOpen ? 'gap-3 px-4 justify-start' : 'justify-center px-0' }}"
           :class="(isMobile || sidebarOpen) ? '!gap-3 !px-4 !justify-start' : '!justify-center !px-0'">
        ...
        <a href="{{ route('analytics') }}" @click="if(window.innerWidth < 1024) sidebarOpen = false" aria-label="Analisis" title="Analisis"
           class="flex items-center py-3 rounded-lg transition-colors font-headline text-sm tracking-tight
                  {{ $currentRoute === 'analytics' ? 'text-primary font-semibold border-r-2 border-primary bg-surface-container-high/80' : 'text-on-surface-variant hover:bg-surface-container-high/70 hover:text-on-surface' }}
                  {{ $isSidebarOpen ? 'gap-3 px-4 justify-start' : 'justify-center px-0' }}"
           :class="(isMobile || sidebarOpen) ? '!gap-3 !px-4 !justify-start' : '!justify-center !px-0'">
        ...
        <a href="{{ route('report-attendances.index') }}" @click="if(window.innerWidth < 1024) sidebarOpen = false" aria-label="Monitoring Laporan" title="Monitoring Laporan"
           class="flex items-center py-3 rounded-lg transition-colors font-headline text-sm tracking-tight
                  {{ str_starts_with($currentRoute, 'report-attendances') ? 'text-primary font-semibold border-r-2 border-primary bg-surface-container-high/80' : 'text-on-surface-variant hover:bg-surface-container-high/70 hover:text-on-surface' }}
                  {{ $isSidebarOpen ? 'gap-3 px-4 justify-start' : 'justify-center px-0' }}"
           :class="(isMobile || sidebarOpen) ? '!gap-3 !px-4 !justify-start' : '!justify-center !px-0'">
        ...
        <a href="{{ route('master-data.index') }}" @click="if(window.innerWidth < 1024) sidebarOpen = false" aria-label="Master Data" title="Master Data"
           class="flex items-center py-3 rounded-lg transition-colors font-headline text-sm tracking-tight
                  {{ str_starts_with($currentRoute, 'master-data') ? 'text-primary font-semibold border-r-2 border-primary bg-surface-container-high/80' : 'text-on-surface-variant hover:bg-surface-container-high/70 hover:text-on-surface' }}
                  {{ $isSidebarOpen ? 'gap-3 px-4 justify-start' : 'justify-center px-0' }}"
           :class="(isMobile || sidebarOpen) ? '!gap-3 !px-4 !justify-start' : '!justify-center !px-0'">
        ...
        <a href="{{ route('settings') }}" @click="if(window.innerWidth < 1024) sidebarOpen = false" aria-label="Pengaturan" title="Pengaturan"
           class="flex items-center py-3 rounded-lg transition-colors font-headline text-sm tracking-tight
                  {{ $currentRoute === 'settings' ? 'text-primary font-semibold border-r-2 border-primary bg-surface-container-high/80' : 'text-on-surface-variant hover:bg-surface-container-high/70 hover:text-on-surface' }}
                  {{ $isSidebarOpen ? 'gap-3 px-4 justify-start' : 'justify-center px-0' }}"
           :class="(isMobile || sidebarOpen) ? '!gap-3 !px-4 !justify-start' : '!justify-center !px-0'">
